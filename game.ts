/**
 * Attributions:
 *  "gamewin.mp3" sound effect obtained from https://www.zapsplat.com
 *  "Axletree - The Woods (remastered).mp3" obtained from Axletree via the FMA https://freemusicarchive.org/music/Axletree/ 
 *  Rotation sound effects recorded by myself
 */
...
Have fun!
                ...
                // This site is hell.
                // Attention economy garbage.
                // It brings out the worst in us.
                // const twitterIcon: SocialMediaIcon = new SocialMediaIcon('icons/twitter.svg', 'NEVER AGAIN');
                ...
                const githubIcon: SocialMediaIcon = new SocialMediaIcon('icons/github.svg', 'https://github.com/gregorykau');
